                            ...
                            <div class="row">
                                            ...
                                            <table id="employee-table">
                                                ...
                                                <tbody>
                                                    <tr class="listitems" id="itemId_1">
                                                        <td>
                                                            <select class="selItem" name="name[]" id="item_item_1" style='width: 200px;'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="d-flex">
                                            <input class="form-control" id="Discount" onchange="calculate2(this)" type="number" value="0" name="Discount">
